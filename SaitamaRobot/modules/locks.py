...
LOCK_HANDLER = CommandHandler("lock", lock, pass_args=True)  # , Filters.chat_type.groups, run_async=True)
UNLOCK_HANDLER = CommandHandler(
    "unlock", unlock, pass_args=True,
)  # , Filters.chat_type.groups, run_async=True)
LOCKED_HANDLER = CommandHandler("locks", list_locks)  # , Filters.chat_type.groups, run_async=True)
