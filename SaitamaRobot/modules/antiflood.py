...
SET_FLOOD_HANDLER = CommandHandler("setflood", set_flood, Filters.chat_type.groups, run_async=True)
...
FLOOD_HANDLER = CommandHandler("flood", flood, Filters.chat_type.groups, run_async=True)
