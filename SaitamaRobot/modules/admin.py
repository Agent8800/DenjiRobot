...
PIN_HANDLER = CommandHandler("pin", pin, Filters.chat_type.groups, run_async=True)
UNPIN_HANDLER = CommandHandler("unpin", unpin, Filters.chat_type.groups, run_async=True)
...
ADMIN_REFRESH_HANDLER = CommandHandler(
    "admincache", refresh_admin, Filters.chat_type.groups,
)
